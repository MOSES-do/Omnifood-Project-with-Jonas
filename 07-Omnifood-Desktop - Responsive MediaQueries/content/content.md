...
html {
    /* font-size: 10px; */
    /* 10px /16px = 0.625 i.e. 0.625 *100 = 62.5% */
    /* for accressibility */
    font-size: 62.5%;
}
...
.test {
    /* Max-width adapts to the parent element once its width is less than the parent i.e. adapting to the width of the parant element */
    /* max-width: 1000px; */
    padding: 100px;
    background-color: red;
    /* if not set on the html element the default size for 1rem = 16px  16px*50rem=800px*/
    max-width: 50rem;
}